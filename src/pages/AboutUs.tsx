    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "About Us", url: `${BUSINESS_DATA.url}/about` }
        ]}
      />
      <SpeakableSchema
        headline="About Champions Sports Bar & Grill - Meet the Owners"
        description="Meet Jared Bailie and Michelle Wales, the family behind Hillsboro's favorite community sports bar. Learn about our commitment to local sourcing, community involvement, and creating unforgettable experiences."
        ...
        <div className="py-16 md:py-24">
          <div className="container">
            <div className="text-center max-w-4xl mx-auto">
              <p className="mt-4 text-lg md:text-xl text-muted-foreground speakable-content">
            ...
            <div className="mt-24 space-y-16 max-w-4xl mx-auto">
              <div ref={jaredSectionRef} className="animate-fade-in">
                <h2 className="font-serif text-4xl font-semibold mb-2 speakable-content">Jared Bailie</h2>
              ...
              animationDelay: '200ms'
                ...
                <h2 className="font-serif text-4xl font-semibold mb-2 speakable-content">Michelle Wales</h2>
              ...
              animationDelay: '400ms'
                ...
                <h2 className="font-serif text-4xl font-semibold mb-4 speakable-content">A Team with Purpose</h2>
                <div className="text-muted-foreground text-lg space-y-4 leading-relaxed">
                    <p>
              ...
              animationDelay: '600ms'
                  ...
                  <h2 className="font-serif text-4xl font-semibold mb-4 text-center speakable-content">What Sets Jared & Michelle Apart</h2>
            ...
            <div className="mt-24 text-center">
                <h2 className="text-4xl font-serif font-semibold speakable-content">Locally Sourced. Seasonally Inspired. </h2>
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-6 pt-0">
                    <div className="relative bg-muted/30 rounded-lg p-1 aspect-square flex items-center justify-center">
                      <img 
