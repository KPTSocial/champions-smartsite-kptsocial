        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 xl:gap-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2">
              <img src="/lovable-uploads/3945cf0e-e4bd-4a9f-b682-9710e263952f.png" alt="Champions Sports Bar & Grill Logo" className="h-16 w-16 object-contain" />
              <span className="font-serif text-3xl font-bold">
                Champions
              </span>
            </Link>
            <p className="mt-4 text-sm text-secondary-foreground/70">Your home-field hangout, loaded with locally inspired eats.</p>
            ...
            <div className="mt-6">
              ...
              <div className="mt-4 flex gap-4">
                <a href="https://www.facebook.com/profile.php?id=100063835066138#" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 transition-colors" aria-label="Follow us on Facebook">
                  <Facebook className="h-6 w-6" />
                </a>
                <a href="https://www.instagram.com/champs_hillsboro/?hl=en" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 transition-colors" aria-label="Follow us on Instagram">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link to="/loyalty" className="hover:text-primary transition-colors">Loyalty & Rewards</Link></li>
          ...
          <div>
            ...
            <div className="mt-4 rounded-md overflow-hidden shadow-lg h-64 bg-secondary-foreground/10">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2795.6823432717!2d-122.9064566236949!3d45.51352892978016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54950fa5f8c858e7%3A0x1d1e67e3a3a4b6c!2s2947%20SE%2073rd%20Ave%2C%20Hillsboro%2C%20OR%2097123!5e0!3m2!1sen!2sus!4v1718486980121!5m2!1sen!2sus" className="w-full h-full" style={{
              border: 0
            }} allowFullScreen={false} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Google Map of Champions Sports Bar & Grill location"></iframe>
            </div>
          </div>
